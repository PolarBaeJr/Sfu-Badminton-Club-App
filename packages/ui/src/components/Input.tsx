    ...
    return (
      <div className="space-y-1">
        ...
        <input
          ...
          className={cn(
            // rounded-[var(--r-control,8px)], not rounded-[8px], so the corner
            // stays reachable from one token: the console sets --r-control: 8px
            // in its globals.css, and the player app sets nothing and takes the
            // same 8px from the fallback.
