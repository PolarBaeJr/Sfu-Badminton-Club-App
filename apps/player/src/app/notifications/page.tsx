...
const NOTIFICATION_ICON_MAP: Record<string, { icon: typeof Bell; color: string; bg: string }> = {
  ...
  // Result types
  result_pending: { icon: Trophy, color: 'text-gold', bg: 'bg-[#FFD700]/10' },
  ...
  // Other types
  rank_changed: { icon: TrendingUp, color: 'text-gold', bg: 'bg-[#FFD700]/10' },
  session_reminder: { icon: Calendar, color: 'text-blue-400', bg: 'bg-blue-500/10' },
  announcement: { icon: Megaphone, color: 'text-gold', bg: 'bg-[#FFD700]/10' },
  tournament_update: { icon: Trophy, color: 'text-gold', bg: 'bg-[#FFD700]/10' },
