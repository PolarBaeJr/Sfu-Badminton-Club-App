...
// Mirror of the player app's suite: the console's sign-in button relies on the
// same cache to start synchronously from the tap on iOS, and to never mint a
// second challenge while one is still usable.
