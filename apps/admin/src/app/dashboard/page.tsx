...
export default async function DashboardPage() {
  ...
  // /players is trainer-readable, but approving is exec work — the Edit control
  // below saves through updatePlayer/approvePlayer, both of which gate on
  // getExecOrAdmin(). Asking the level directly rather than reusing showPlayers
