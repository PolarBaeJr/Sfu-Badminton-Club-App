...
//
// The console is built with basePath=/admin, so the served URL is
// /admin/api/health/live — the prefix is NOT part of this file's path, and the
// middleware matcher below it matches basePath-relative paths. Three different
// spellings of the same route; see the healthcheck in docker-compose.yml.
//
