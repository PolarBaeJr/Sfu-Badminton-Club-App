...
//
// Served at /admin/api/health/ready: the console is built with basePath=/admin,
// which is not part of this file's path. Probing the wrong one of the two is
// exactly the 404 the old `status < 500` healthcheck called healthy.
