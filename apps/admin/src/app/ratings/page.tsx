...
//
// getAuthenticatedAdmin(), not the exec gate Legal uses: the club owner asked
// for these to be "separate from exec so they cant edit it", and unlike the
// legal documents there is nothing here an exec has a reason to read — so there
// is no read-only view. SECTION_ACCESS only decides who may OPEN the section;
// this call is the page's own re-check, and updatePlatformSettings' getAdminPlayer()
